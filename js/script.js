document.addEventListener("DOMContentLoaded", () => document.getElementById("report").style.display = "none"
);
...
function printToFile() {
    document.getElementById("foot-cont").innerHTML = '<div class="flow-text" style="margin-top:30px">Generated Using WhatsApp Stat </div>';
